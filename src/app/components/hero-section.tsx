...
const HeroSection = () => {
  return (
    <section className="bg-bannerImage bg-no-repeat bg-cover bg-bottom w-full border-0 p-0 m-0 min-h-screen">
      {/* <Navbar /> */}
      <div className=" h-screen w-full flex items-end bg-blackOverlay">
        <div className="container mx-auto mb-44 md:mb-40 px-2 md:px-4">
          <h1 className="md:text-4xl text-3xl md:font-bold leading-tight md:mb-4 font-semibold">
            Welcome to La Ben
          </h1>
          <p className="text-lg text-left text-white-600">
